...
import { Absent_Participent_List } from 'common/ParticipentData';

function AbsentParticipent() {
        ...
        <Card>
          <CardBody>
            <div className="d-flex align-items-center">
              <h5 className="mb-0 card-title flex-grow-1">Absent Participant List</h5>
...
export default AbsentParticipent;
